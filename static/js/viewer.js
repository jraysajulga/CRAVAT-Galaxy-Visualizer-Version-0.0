...
define(['plugin/Views/tabs','plugin/Models/data','plugin/collections/data','plugin/views/panel','plugin/views/summary','plugin/Models/summary'],
    ...
    return Backbone.View.extend({
    	...
    	initialize: function(options){
            ...
            this.summaryPanel = new SummaryView({model : summaryModel, n: 0,  id : 'Summary'});
          	this.genePanel      = new PanelView({model : geneData, n: 1,      id : 'Gene',      table : true});
          	this.codingPanel    = new PanelView({model : codingData, n: 2,   id : 'Variant',    frameViewer : true});
            this.noncodingPanel = new PanelView({model : noncodingData, n: 3, id : 'Noncoding', table : true});
            this.errorPanel     = new PanelView({model : errorData, n: 4,    id : 'Error',      table : true});
